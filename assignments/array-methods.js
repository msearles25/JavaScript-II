...
runners.map(function(name) {
  return firstNamesAllCaps.push(name.first_name.toUpperCase());
});
...
runners.reduce(function(accumulator, donationTotal) {
  ticketPriceTotal = accumulator + donationTotal.donation;
